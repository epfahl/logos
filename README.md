...
To get acclimated to the usage of `Logos`, start with a simple algebra question: _What is the value of the variable `x` when `x` is equal to 1?_ This isn't a trick; the answer, `x = 1`, is in the phrasing of the question. In `Logos`, this question is expressed as
